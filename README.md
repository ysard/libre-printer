...
[![documentation](https://readthedocs.org/projects/libre-printer/badge/)](https://libre-printer.readthedocs.io/en/latest/)
...
- **HP PJL (Printer Job Language):**
    ...
    See more [here](https://github.com/ysard/libreprinter-pjl).
