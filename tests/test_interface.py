...
def test_endlesstext_values(extra_config, in_file, expected_file, out_file, repetitions, tmp_process):
    ...
    :param extra_config: (fixture) Temporary directory and configParser
    ...
    with open(DIR_DATA + in_file, "rb") as f_d:
        raw_content = f_d.read()

    with open(DIR_DATA + expected_file, "rb") as f_d:
        expected_content = f_d.read()
    ...
    print("Dir tree: ", ret)
    print(processed_file, processed_file.stat())
