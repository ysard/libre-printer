...
def test_interface_receiving(
    ...
    :param handle_module_cache: (fixture) Regenerate the available set of plugins
        before tests
    :type emulation: str
    :type test_file: str
    :type init_config: tuple[str, configparser.ConfigParser]
...
def test_endlesstext_values(
    ...
    def wrapper(config):
        ...
        LOGGER.debug("PID child: %s", os.getpid())
